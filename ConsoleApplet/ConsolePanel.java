...
public class ConsolePanel extends Panel {
   ...
   public void put(String x, Color c) { put(x,0,c); }
   ...
   public void putln(String x, Color c) { put(x,0,c); newLine(); }
   ...
   public void putln(String x, int w, Color c) { put(x,w,c); newLine(); }
   ...
   public void put(String x, int w, Color c) { dumpString(x, w, c); }
   ...
   private void dumpString(String str, int w) {
     dumpString(str, w, Color.black);
   }

   private void dumpString(String str, int w, Color c) {   // output string to console
     
      for (int i=str.length(); i<w; i++)
         canvas.addChar(' ', c);
      for (int i=0; i<str.length(); i++)
         if ((int)str.charAt(i) >= 0x20 && (int)str.charAt(i) != 0x7F)  // no control chars or delete
            canvas.addChar(str.charAt(i), c);
